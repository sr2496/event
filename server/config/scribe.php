...
return [
    ...
    'title' => 'Event Reliability Platform API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API for the Event Reliability Platform - connecting clients with reliable vendors for events with built-in backup systems.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<INTRO
        Welcome to the Event Reliability Platform API documentation.
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain your access token by calling the <b>POST /api/auth/login</b> endpoint with your credentials. Include the token in the Authorization header as: <code>Bearer {token}</code>',
    ],
